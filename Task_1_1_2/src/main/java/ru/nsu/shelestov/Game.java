...
public class Game {
     ...
     * Проверка количества оставшихся карт в колоде и
     * перетасовка колоды из сброшенных карт, если необходимо
    ...
    public void startRound() {
        ...
        if (response.equals("да")) {
            ...
            System.out.println("Спасибо за игру! Ваш счет: " + wins + " побед, " + losses
                    + " поражений, " + draws + " ничьих.");
        }
    }
     ...
     * Если игрок выбирает остановиться (вводит "0"), устанавливается флаг
     * для перехода к следующему этапу игры
     * Если введено неверное значение, выводится сообщение об ошибке,
     * и игроку предлагается попробовать снова
     */
